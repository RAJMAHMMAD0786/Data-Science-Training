...
print(venue_matches[['season', 'team1', 'team2', 'winner']])
...
bat_first_wins = bat_first['winner'].value_counts()

field_first = df[df['win_by_wickets'] > 0]
field_first_wins = field_first['winner'].value_counts()

total_wins = df['winner'].value_counts()

bonus_df = pd.DataFrame({
    'Batting First Wins': bat_first_wins,
    'Fielding First Wins': field_first_wins,
    'Total Wins': total_wins
}).fillna(0)

bonus_df['Bat First Win %'] = (bonus_df['Batting First Wins'] / bonus_df['Total Wins']) * 100
bonus_df['Field First Win %'] = (bonus_df['Fielding First Wins'] / bonus_df['Total Wins']) * 100

print(bonus_df.sort_values(by='Total Wins', ascending=False))